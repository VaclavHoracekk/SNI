...
\title[Title of Student's Thesis]{Měření průtoku vzduchu}

%%% Označení oboru studia
%  Parametr ve složených závorkách {} je název oboru v originálním jazyce,
%  parametr v hranatých závorkách [] je překlad
\specialization[Automation and measurement technologie]{Automatizace a měřící technika}
...
\facultylogo[logo/FEKT_zkratka_barevne_PANTONE_CZ]{UAMT_color_CMYK_CZ}
