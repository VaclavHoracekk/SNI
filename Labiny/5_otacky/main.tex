...
\section{Úkol 5 - Průběhy signálů z měření ozubených kol}
    ...
    \subsection{Naměřené hodnoty}
        \printfigure[Průběh výstupního signálu pro kolo s hranatými zuby]{src/5_integral_1_kolo.png}{0.6}{hrany}
        \printfigure[Průběh výstupního signálu pro kolo s mělkými hranatými zuby]{src/5_integral_2_kolo.png}{0.6}{melke_hrany}
        \printfigure[Průběh výstupního signálu pro kolo s zuby ve tvaru rampy]{src/5_integral_3_kolo.png}{0.6}{rampa}
        \printfigure[Průběh výstupního signálu pro kolo s trojúhelníkovými zuby]{src/5_integral_4_kolo.png}{0.6}{trojuhelnik}
    \subsection{Zpracované výsledky měření}
    \subsection{Závěr}
